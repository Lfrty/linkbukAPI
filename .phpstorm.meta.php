...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/matt/Documentos/Proyectos Web/proyecto/linkbukAPI/public/storage' => 'string',
            ...
            'services.book_archive.url' => 'string',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/matt/Documentos/Proyectos Web/proyecto/linkbukAPI/public/storage',
...
'services.ses.secret','services.ses.region','services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','services.book_archive.url',
...
'signed','throttle','verified','checkRol',);
...
'AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','BOOK_ARCHIVE_URL',);
